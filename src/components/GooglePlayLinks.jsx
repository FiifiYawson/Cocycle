...
function GooglePlayLinks() {
  return (
    <Stack direction="row" gap="16px" justifyContent="center" flexWrap="wrap">
      <Stack direction="row" gap="15px" alignItems="center" className="rounded-[12px] p-[12px] bg-primary text-white">
      ...
      <Stack direction="row" gap="15px" alignItems="center" className="rounded-[12px] p-[12px] border-[1px] border-dark-grey">
        <img src={googleBlack} alt="Google Play" />
        <div>
